...
async function main() {
  ...
  // ── 1. Users ──────────────────────────────────────────────
  const usersData = [
    { username: "admin",  display_name: "Alex Rivera", password: "admin123",  role: "admin" },
  ...
  const ticketsData = [
    {
      ...
      tag: "Hot", category: "Zillow", assigned_to: "Priya Shah",
      checklist: [
    ...
    },
    {
      ...
      tag: "Warm", category: "Referral", assigned_to: "Jordan Lee",
      checklist: [
        { label: "ID collected", done: false },
        { label: "Pay stubs / bank statements", done: false },
        { label: "Rental history checked", done: false },
    ...
    },
    {
      ...
      tag: "Emergency", category: "HVAC", assigned_to: "Vendor: ColdStar HVAC",
      checklist: [
    ...
    },
    {
      ...
      tag: "Standard", category: "Standard Turn", assigned_to: "Jordan Lee",
      checklist: [
    ...
    },
    {
      ...
      tag: "Moderate", category: "Non-payment", assigned_to: "Priya Shah",
      checklist: [
  ...
  console.log("  priya / priya123  (role: staff)");
  console.log("  jordan / jordan123 (role: staff)");
}
